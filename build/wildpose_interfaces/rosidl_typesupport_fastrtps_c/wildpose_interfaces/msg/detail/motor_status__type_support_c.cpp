...
#include "wildpose_interfaces/msg/detail/motor_status__rosidl_typesupport_fastrtps_c.h"
...
using _MotorStatus__ros_msg_type = wildpose_interfaces__msg__MotorStatus;
...
size_t get_serialized_size_wildpose_interfaces__msg__MotorStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorStatus__ros_msg_type * ros_message = static_cast<const _MotorStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MotorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wildpose_interfaces__msg__MotorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wildpose_interfaces
size_t max_serialized_size_wildpose_interfaces__msg__MotorStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_wildpose_interfaces__msg__MotorStatus(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wildpose_interfaces, msg, MotorStatus)() {
