...
static const _LensAperture_type_support_symbol_names_t _LensAperture_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wildpose_interfaces, msg, LensAperture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wildpose_interfaces, msg, LensAperture)),
  }
};
...
{
  return &::wildpose_interfaces::msg::rosidl_typesupport_cpp::LensAperture_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wildpose_interfaces, msg, LensAperture)() {
  return get_message_type_support_handle<wildpose_interfaces::msg::LensAperture>();
}
