...
bool wildpose_interfaces__msg__motor_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wildpose_interfaces.msg._motor_status.MotorStatus", full_classname_dest, 49) == 0);
  }
  wildpose_interfaces__msg__MotorStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // revolution
    ...
    ros_message->revolution = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * wildpose_interfaces__msg__motor_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wildpose_interfaces.msg._motor_status");
