...
ximea_cam_parameters = {
    'serial_no': "29970951",
    'cam_name': "ximea_MQ022CG-CM",
    'frame_id': '0',
    #'num_cams_in_bus': 1,
    #'bw_safetyratio': 1.0,
    #'poll_time': 2.0,
    'poll_time_frame': 1/120,  # Assuming 120 FPS
    'publish_xi_image_info': True,
    "image_directory": "/home/dev/",
    "save_disk": False,
    "calib_mode": False,
    ...
    "cam_trigger_mode": 0,
    "hw_trigger_edge": 0,
    "frame_rate_control": True,  # Disable frame rate control
    "frame_rate_set": 120,       # Set to 120 FPS
    "img_capture_timeout": 1000,
    "auto_exposure": False,      # Disable auto exposure
    "exposure_time": 12000,       # Set manual exposure time
    "manual_gain": 9.0,
    "auto_exposure_priority": 0.8,
    "auto_time_limit": 30000,
    "auto_gain_limit": 2.0,
    "white_balance_mode": 2,
    "white_balance_coef_red": 3.0,
    "white_balance_coef_green": 0.0,
    "white_balance_coef_blue": 4.0,
    "roi_left": 384,
    "roi_top": 184,
    "roi_width": 1280,
    "roi_height": 720,
...
ximea_cam_parameters2 = {
    ...
    'bw_safetyratio': 1.0,  # Bandwidth safety ratio, a multiplier to the bandwidth allocated for each camera
    'poll_time': 2.0, # Used to set the duration (in seconds) which the camera is attempted to be opened again.
    'poll_time_frame': 1/200, # the ROS timer loop period (in seconds) for the ximea camera node. It should generally be set to a rate that is a factor higher than the camera capture rate.
    'publish_xi_image_info': True,    # Flag for publishing the extra ximea camera information provided with each image acquisition.
